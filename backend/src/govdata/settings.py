"""
Django settings for govdata project.
...
SECRET_KEY = "django-insecure-19%n+wt$pd6$!y!@mk#zlx(!ty7r@p%-u7l!lk+b=6)fkm#z$i"
...
WSGI_APPLICATION = "govdata.wsgi.application"
...
STATIC_URL = "static/"
STATICFILES_DIRS = [BASE_DIR / "govdata" / "static"]
...
storages._storages["default"] = MinioMediaStorage()
